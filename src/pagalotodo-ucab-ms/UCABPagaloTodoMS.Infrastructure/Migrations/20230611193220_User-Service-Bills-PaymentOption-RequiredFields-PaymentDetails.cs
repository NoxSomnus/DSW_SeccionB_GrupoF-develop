...
{
    public partial class UserServiceBillsPaymentOptionRequiredFieldsPaymentDetails : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "PaymentRequiredFieldEntities",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PaymentRequiredFieldEntities", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PaymentRequiredFieldEntities_PaymentOptionEntities_PaymentO~",
                        column: x => x.PaymentOptionId,
                        principalTable: "PaymentOptionEntities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "PaymentDetailsEntities",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    FieldContent = table.Column<string>(type: "text", nullable: true),
                    BillId = table.Column<Guid>(type: "uuid", nullable: false),
                    RequiredFieldId = table.Column<Guid>(type: "uuid", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CreatedBy = table.Column<string>(type: "text", nullable: true),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    UpdatedBy = table.Column<string>(type: "text", nullable: true)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PaymentDetailsEntities", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PaymentDetailsEntities_BillEntities_BillId",
                        column: x => x.BillId,
                        principalTable: "BillEntities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PaymentDetailsEntities_PaymentRequiredFieldEntities_Require~",
                        column: x => x.RequiredFieldId,
                        principalTable: "PaymentRequiredFieldEntities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PaymentDetailsEntities_BillId",
                table: "PaymentDetailsEntities",
                column: "BillId");

            migrationBuilder.CreateIndex(
                name: "IX_PaymentDetailsEntities_RequiredFieldId",
                table: "PaymentDetailsEntities",
                column: "RequiredFieldId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PaymentRequiredFieldEntities_PaymentOptionId",
                table: "PaymentRequiredFieldEntities",
                column: "PaymentOptionId");
