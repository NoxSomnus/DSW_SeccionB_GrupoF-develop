...
namespace UCABPagaloTodoMS.Controllers
{
    ...
    public class UserQueryController : BaseController<UserQueryController>
    {
        ...
        public async Task<ActionResult> AllUsers()
        {
            ...
            {
                _logger.LogError("Ocurrio un error en la consulta de los usuarios: No hay usuarios registrados" + ex);
        ...
        public async Task<ActionResult> byDni([FromQuery] string Dni)
        {
            ...
            {
                _logger.LogError("Ocurrio un error en la consulta de los usuarios: No se encontró el usuario" + ex);
                return NotFound(ex.Message);
            }
            catch (Exception ex)
            {
        ...
        public async Task<ActionResult> AllProviders()
        {
            ...
            {
                _logger.LogError("Ocurrio un error en la consulta de los proveedores de servicio: No hay proveedores de servicio registrados" + ex);
                return NotFound(ex.Message);
            }
            catch (Exception ex)
            {
